...
- [13. Управление поведением Cursor](#13-управление-поведением-cursor)
  - [13.1. Глобальные и проектные правила](#131-глобальные-и-проектные-правила)
  - [13.2. Файл .cursorrules](#132-файл-cursorrules)
  - [13.3. Настройка .cursorignore](#133-настройка-cursorignore)
  - [13.4. Директория .cursor/rules](#134-директория-cursorrules)
  - [13.5. Шаблоны правил для различных типов проектов](#135-шаблоны-правил-для-различных-типов-проектов)

### III. Разработка проектов
- [14. Разработка проекта](#14-разработка-проекта)
  - [14.1. Добавление функциональности](#141-добавление-функциональности)
  - [14.2. Тестирование](#142-тестирование)
  - [14.3. Рефакторинг](#143-рефакторинг)
  - [14.4. Управление версиями и откаты](#144-управление-версиями-и-откаты)
- [15. Технологии и фреймворки](#15-технологии-и-фреймворки)
  - [15.1. Фронтенд - Flutter](#151-фронтенд---flutter)
  - [15.2. Backend](#152-backend)
    - [15.2.1. Java и JHipster](#1521-java-и-jhipster)
    - [15.2.2. NodeJS](#1522-nodejs)
  - [15.3. Интеграция - N8N](#153-интеграция---n8n)

### IV. Лучшие практики и рекомендации
- [16. Лучшие практики использования Cursor](#16-лучшие-практики-использования-cursor)
- [17. Полезные ссылки](#17-полезные-ссылки)
  - [17.1. Документация основных инструментов](#171-документация-основных-инструментов)
  - [17.2. Документация по языкам программирования](#172-документация-по-языкам-программирования)
  - [17.3. Документация по фреймворкам](#173-документация-по-фреймворкам)

### V. Правовые и организационные аспекты
- [18. Регистрация и учетные записи](#18-регистрация-и-учетные-записи)
  - [18.1. Процесс регистрации](#181-процесс-регистрации)
  - [18.2. Типы подписок](#182-типы-подписок)
  - [18.3. Особенности лицензирования](#183-особенности-лицензирования)
    - [18.3.1. Hobby (Бесплатный план)](#1831-hobby-бесплатный-план)
    - [18.3.2. Pro (Профессиональный план)](#1832-pro-профессиональный-план)
    - [18.3.3. Business (Корпоративный план)](#1833-business-корпоративный-план)
    - [18.3.4. Быстрые и медленные запросы](#1834-быстрые-и-медленные-запросы)
    - [18.3.5. Права на сгенерированный код](#1835-права-на-сгенерированный-код)
    - [18.3.6. Связь с безопасностью](#1836-связь-с-безопасностью)
  - [18.4. Подключение собственных моделей](#184-подключение-собственных-моделей)
    - [18.4.1. Поддерживаемые провайдеры API](#1841-поддерживаемые-провайдеры-api)
    - [18.4.2. Настройка собственного API-ключа](#1842-настройка-собственного-api-ключа)
    - [18.4.3. Особенности использования собственных API-ключей](#1843-особенности-использования-собственных-api-ключей)
    - [18.4.4. Настройка DeepSeek и других альтернативных моделей](#1844-настройка-deepseek-и-других-альтернативных-моделей)
    - [18.4.5. Мониторинг использования](#1845-мониторинг-использования)
- [19. Безопасность и конфиденциальность](#19-безопасность-и-конфиденциальность)
  - [19.1. Обработка данных в Cursor](#191-обработка-данных-в-cursor)
  - [19.2. Меры безопасности](#192-меры-безопасности)
  - [19.3. Лучшие практики безопасности](#193-лучшие-практики-безопасности)

### VI. Обновления и версионность
- [20. Информация о версиях](#20-информация-о-версиях)
  - [20.1. Актуальная версия](#201-актуальная-версия)
  - [20.2. План обновления документации](#202-план-обновления-документации)
  - [20.3. История изменений](#203-история-изменений)
