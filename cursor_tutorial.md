...
- [5. Настройка проекта для разработки](#5-настройка-проекта-для-разработки)
  ...
  - [5.4. Стандартные инструменты разработки](#54-стандартные-инструменты-разработки)
    - [5.4.1. Установка и проверка необходимых инструментов](#541-установка-и-проверка-необходимых-инструментов)
...
- [7. Горячие клавиши и продуктивность](#7-горячие-клавиши-и-продуктивность)
  - [7.1. Горячие клавиши AI-функций](#71-горячие-клавиши-ai-функций)
  - [7.2. Навигация и поиск](#72-навигация-и-поиск)
  - [7.3. Редактирование кода](#73-редактирование-кода)
  - [7.4. Терминал и отладка](#74-терминал-и-отладка)
  - [7.5. Управление редактором](#75-управление-редактором)
- [8. Решение проблем](#8-решение-проблем)
- [9. Полезные ссылки](#9-полезные-ссылки)
  - [9.1. Документация основных инструментов](#91-документация-основных-инструментов)
  - [9.2. Документация по языкам программирования](#92-документация-по-языкам-программирования)
  - [9.3. Документация по фреймворкам](#93-документация-по-фреймворкам)
- [10. Практические примеры](#10-практические-примеры)
  - [10.1. Анализ кодовой базы](#101-анализ-кодовой-базы)
  - [10.2. Автоматическое рефакторирование](#102-автоматическое-рефакторирование)
  - [10.3. Создание тестов](#103-создание-тестов)
  - [10.4. Разработка с использованием AI-ассистента](#104-разработка-с-использованием-ai-ассистента)
  - [10.5. Документирование кода](#105-документирование-кода)
- [11. Интеграция с внешними инструментами](#11-интеграция-с-внешними-инструментами)
  - [11.1. Интеграция с системами CI/CD](#111-интеграция-с-системами-cicd)
  - [11.2. Интеграция с инструментами командной работы](#112-интеграция-с-инструментами-командной-работы)
  - [11.3. Взаимодействие с другими IDE и редакторами](#113-взаимодействие-с-другими-ide-и-редакторами)
- [12. Безопасность и конфиденциальность](#12-безопасность-и-конфиденциальность)
  - [12.1. Обработка данных в Cursor](#121-обработка-данных-в-cursor)
  - [12.2. Меры безопасности](#122-меры-безопасности)
  - [12.3. Лучшие практики безопасности](#123-лучшие-практики-безопасности)
- [13. Информация о версиях](#13-информация-о-версиях)
  - [13.1. Актуальная версия](#131-актуальная-версия)
  - [13.2. План обновления документации](#132-план-обновления-документации)
  - [13.3. История изменений](#133-история-изменений)
- [14. Управление поведением Cursor](#14-управление-поведением-cursor)
  - [14.1. Глобальные и проектные правила](#141-глобальные-и-проектные-правила)
  - [14.2. Файл .cursorrules](#142-файл-cursorrules)
  - [14.3. Настройка .cursorignore](#143-настройка-cursorignore)
  - [14.4. Директория .cursor/rules](#144-директория-cursorrules)
  - [14.5. Шаблоны правил для различных типов проектов](#145-шаблоны-правил-для-различных-типов-проектов)

### III. Разработка проектов
- [15. Разработка проекта](#15-разработка-проекта)
  - [15.1. Добавление функциональности](#151-добавление-функциональности)
  - [15.2. Тестирование](#152-тестирование)
  - [15.3. Рефакторинг](#153-рефакторинг)
  - [15.4. Управление версиями и откаты](#154-управление-версиями-и-откаты)
- [16. Технологии и фреймворки](#16-технологии-и-фреймворки)
  - [16.1. Фронтенд - Flutter](#161-фронтенд---flutter)
  - [16.2. Backend](#162-backend)
    - [16.2.1. Java и JHipster](#1621-java-и-jhipster)
    - [16.2.2. NodeJS](#1622-nodejs)
  - [16.3. Интеграция - N8N](#163-интеграция---n8n)

### IV. Лучшие практики и рекомендации
- [17. Лучшие практики использования Cursor](#17-лучшие-практики-использования-cursor)
- [18. Полезные ссылки](#18-полезные-ссылки)
  - [18.1. Документация основных инструментов](#181-документация-основных-инструментов)
  - [18.2. Документация по языкам программирования](#182-документация-по-языкам-программирования)
  - [18.3. Документация по фреймворкам](#183-документация-по-фреймворкам)

### V. Правовые и организационные аспекты
- [19. Регистрация и учетные записи](#19-регистрация-и-учетные-записи)
  - [19.1. Процесс регистрации](#191-процесс-регистрации)
  - [19.2. Типы подписок](#192-типы-подписок)
  - [19.3. Особенности лицензирования](#193-особенности-лицензирования)
    - [19.3.1. Hobby (Бесплатный план)](#1931-hobby-бесплатный-план)
    - [19.3.2. Pro (Профессиональный план)](#1932-pro-профессиональный-план)
    - [19.3.3. Business (Корпоративный план)](#1933-business-корпоративный-план)
    - [19.3.4. Быстрые и медленные запросы](#1934-быстрые-и-медленные-запросы)
    - [19.3.5. Права на сгенерированный код](#1935-права-на-сгенерированный-код)
    - [19.3.6. Связь с безопасностью](#1936-связь-с-безопасностью)
  - [19.4. Подключение собственных моделей](#194-подключение-собственных-моделей)
    - [19.4.1. Поддерживаемые провайдеры API](#1941-поддерживаемые-провайдеры-api)
    - [19.4.2. Настройка собственного API-ключа](#1942-настройка-собственного-api-ключа)
    - [19.4.3. Особенности использования собственных API-ключей](#1943-особенности-использования-собственных-api-ключей)
    - [19.4.4. Настройка DeepSeek и других альтернативных моделей](#1944-настройка-deepseek-и-других-альтернативных-моделей)
    - [19.4.5. Мониторинг использования](#1945-мониторинг-использования)
- [20. Безопасность и конфиденциальность](#20-безопасность-и-конфиденциальность)
  - [20.1. Обработка данных в Cursor](#201-обработка-данных-в-cursor)
  - [20.2. Меры безопасности](#202-меры-безопасности)
  - [20.3. Лучшие практики безопасности](#203-лучшие-практики-безопасности)

### VI. Обновления и версионность
- [21. Информация о версиях](#21-информация-о-версиях)
  - [21.1. Актуальная версия](#211-актуальная-версия)
  - [21.2. План обновления документации](#212-план-обновления-документации)
  - [21.3. История изменений](#213-история-изменений)
...
### 9.1. Документация основных инструментов
...
### 9.2. Документация по языкам программирования
...
### 9.3. Документация по фреймворкам
...
## 14. Управление поведением Cursor
...
### 14.1. Глобальные и проектные правила
...
### 14.5. Шаблоны правил для различных типов проектов
...
### 15.1. Добавление функциональности
...
### 15.4. Управление версиями и откаты
...
## 16. Технологии и фреймворки

### 16.1. Фронтенд - Flutter
...
## 17. Лучшие практики использования Cursor
...
## 19. Регистрация и учетные записи

### 19.1. Процесс регистрации
...
### 19.3. Особенности лицензирования

#### 19.3.1. Hobby (Бесплатный план)
...
#### 19.3.4. Быстрые и медленные запросы
...
#### 19.3.5. Права на сгенерированный код
...
### 19.4. Подключение собственных моделей

#### 19.4.1. Поддерживаемые провайдеры API
...
#### 19.4.2. Настройка собственного API-ключа
...
#### 19.4.3. Особенности использования собственных API-ключей
...
#### 19.4.4. Настройка DeepSeek и других альтернативных моделей
...
#### 19.4.5. Мониторинг использования
...
### 20.1. Обработка данных в Cursor
...
### 20.3. Лучшие практики безопасности
...
## 21. Информация о версиях

### 21.1. Актуальная версия
...
### 21.2. План обновления документации
